/* ============================================================
   TREE-HR v2 - Arbol de decisiones del area de TALENTO HUMANO
   ...
   10 nodos | 25 dias | 6 choice, 2 binary, 2 multi
   ============================================================ */
...
window.TREE_HR = {
  ...
  nodes: {
    ...
    // ============================================================
    //  NODO 1 — DIA 1: Plan de contratacion (choice x4)
    // ============================================================
    'hr_01': {
      day: 1,
      ...
      options: [
        {
          ...
          crossEffects: [
            { area: 'operations', message: 'Turnos cubiertos al 100% desde el dia 1', bsc: { bsc_internal: 4 }, cost: 0 },
            { area: 'finance', message: 'Carga prestacional alta: ~$28M/mes en nomina', bsc: { bsc_financial: -3 }, cost: -4000000 }
          ],
        ...
        },
        {
          ...
          crossEffects: [
            { area: 'operations', message: 'Temporales requieren mas supervision en procesos', bsc: { bsc_internal: -1 }, cost: 0 },
            { area: 'finance', message: 'Nomina mixta: ~$19M/mes, mas manejable', bsc: { bsc_financial: 2 }, cost: 0 }
          ],
        ...
        },
        {
          ...
          crossEffects: [
            { area: 'operations', message: 'Operador externo controla ritmos y metodos', bsc: { bsc_internal: -3 }, cost: 0 },
            { area: 'marketing', message: 'Personal sin identidad de marca propia', bsc: { bsc_customer: -2 }, cost: 0 }
          ],
          tags: ['outsourcing', 'bajo-costo-inicial', 'sin-control'],
          next: 'hr_02_ext',
        ...
        },
        {
          ...
          crossEffects: [
            { area: 'operations', message: '28 personas cubriendo capacidad para 40: turnos apretados', bsc: { bsc_internal: -3 }, cost: 0 },
            { area: 'finance', message: 'Ahorro inicial de $8M en nomina del primer mes', bsc: { bsc_financial: 3 }, cost: 0 }
          ],
    ...
    // ============================================================
    //  NODO 2 — DIA 4: Cultura organizacional (choice x4)
    // ============================================================
    'hr_02': {
      day: 4,
      ...
      options: [
        {
          ...
          cost: 5000000,
          revenue: 0,
          bsc: { bsc_financial: 1, bsc_customer: 2, bsc_internal: 3, bsc_learning: 1 },
          crossEffects: [
            { area: 'operations', message: 'Empleados aceleran tiempos de servicio por incentivo', bsc: { bsc_internal: 3 }, cost: 0 },
            { area: 'finance', message: 'Bonos mensuales agregan ~$2.5M al gasto fijo', bsc: { bsc_financial: -2 }, cost: -2500000 }
          ],
          tags: ['alto-rendimiento', 'competitiva', 'bonos'],
          next: 'hr_03',
        ...
        },
        {
          ...
          cost: 3000000,
          revenue: 0,
          bsc: { bsc_financial: 0, bsc_customer: 3, bsc_internal: 2, bsc_learning: 4 },
          crossEffects: [
            { area: 'marketing', message: 'Empleados felices generan mejor servicio al cliente', bsc: { bsc_customer: 3 }, cost: 0 }
          ],
          tags: ['familiar', 'colaborativa', 'retencion'],
          next: 'hr_03',
        ...
        },
        {
          ...
          cost: 4000000,
          revenue: 0,
          bsc: { bsc_financial: -1, bsc_customer: 2, bsc_internal: 1, bsc_learning: 5 },
          crossEffects: [
            { area: 'operations', message: 'Rotacion de roles causa curva de aprendizaje en cada area', bsc: { bsc_internal: -2 }, cost: 0 },
            { area: 'marketing', message: 'Propuestas de nuevos platos desde el equipo operativo', bsc: { bsc_customer: 2 }, cost: 0 }
          ],
          tags: ['innovacion', 'aprendizaje', 'rotacion'],
          next: 'hr_03',
        ...
        },
        {
          ...
          cost: 0,
          revenue: 0,
          bsc: { bsc_financial: 2, bsc_customer: -2, bsc_internal: 0, bsc_learning: -3 },
          crossEffects: [
            { area: 'operations', message: 'Sin identidad, cada punto opera diferente', bsc: { bsc_internal: -2 }, cost: 0 }
          ],
          tags: ['sin-cultura', 'ahorro', 'riesgo'],
          next: 'hr_03',
    ...
    // Rama alternativa para outsourcing total
    'hr_02_ext': {
      day: 4,
      ...
      options: [
        {
          ...
          crossEffects: [
            { area: 'marketing', message: 'Personal externo ahora proyecta la identidad de la marca', bsc: { bsc_customer: 2 }, cost: 0 }
          ],
          tags: ['cultura-externa', 'inmersion', 'identidad'],
          next: 'hr_03',
        ...
        },
        {
          ...
          crossEffects: [
            { area: 'marketing', message: 'Atencion generica sin diferenciacion de marca', bsc: { bsc_customer: -3 }, cost: 0 }
          ],
          tags: ['sin-intervencion', 'riesgo-identidad'],
          next: 'hr_03',
    ...
    // ============================================================
    //  NODO 3 — DIA 7: Programa de capacitacion (multi, max 3)
    // ============================================================
    'hr_03': {
      day: 7,
      ...
      options: [
        {
          ...
          crossEffects: [
            { area: 'operations', message: 'Certificacion BPM requerida por Secretaria de Salud', bsc: { bsc_internal: 3 }, cost: 0 }
          ],
          tags: ['sena', 'bpm', 'obligatorio', 'gratuito'],
          next: 'hr_04',
        ...
        },
        {
          ...
          crossEffects: [
            { area: 'marketing', message: 'Cocineros certificados elevan percepcion de calidad', bsc: { bsc_customer: 2 }, cost: 0 }
          ],
          tags: ['gastronomia', 'premium', 'cocineros'],
          next: 'hr_04',
        ...
        },
        {
          ...
          crossEffects: [
            { area: 'marketing', message: 'Servicio al cliente diferenciado aumenta recompra', bsc: { bsc_customer: 3 }, cost: 0 }
          ],
          tags: ['servicio', 'cliente', 'camara-comercio'],
          next: 'hr_04',
        ...
        },
        {
          ...
          crossEffects: [
            { area: 'operations', message: 'Jefes de turno mas autonomos reducen escalamientos', bsc: { bsc_internal: 3 }, cost: 0 }
          ],
          tags: ['liderazgo', 'jefes-turno', 'utp'],
          next: 'hr_04',
        ...
        },
        {
          ...
          crossEffects: [],
          tags: ['induccion-basica', 'bajo-costo', 'minimo'],
          next: 'hr_04',
    ...
    // ============================================================
    //  NODO 4 — DIA 10: Conflicto laboral (binary)
    // ============================================================
    'hr_04': {
      day: 10,
      ...
      options: [
        {
          ...
          cost: 500000,
          revenue: 0,
          bsc: { bsc_financial: 0, bsc_customer: 1, bsc_internal: 4, bsc_learning: 3 },
          crossEffects: [
            { area: 'operations', message: 'Turno nocturno recupera productividad tras acuerdos', bsc: { bsc_internal: 3 }, cost: 0 }
          ],
          tags: ['mediacion', 'acta', 'conflicto'],
          next: 'hr_05',
        ...
        },
        {
          ...
          cost: 200000,
          revenue: 0,
          bsc: { bsc_financial: 1, bsc_customer: 0, bsc_internal: 2, bsc_learning: 0 },
          crossEffects: [
            { area: 'operations', message: 'Cambio de turno altera la dinamica del equipo diurno', bsc: { bsc_internal: -1 }, cost: 0 }
          ],
          tags: ['separacion', 'turnos', 'evasion'],
          next: 'hr_05',
    ...
    // ============================================================
    //  NODO 5 — DIA 13: Evaluacion de desempeno (choice x4)
    // ============================================================
    'hr_05': {
      day: 13,
      ...
      options: [
        {
          ...
          cost: 4000000,
          revenue: 0,
          bsc: { bsc_financial: 1, bsc_customer: 2, bsc_internal: 5, bsc_learning: 3 },
          crossEffects: [
            { area: 'operations', message: 'Datos en tiempo real permiten ajustar turnos sobre la marcha', bsc: { bsc_internal: 4 }, cost: 0 },
            { area: 'finance', message: 'Software de medicion requiere licencia mensual de $300K', bsc: { bsc_financial: -1 }, cost: -300000 }
          ],
          tags: ['kpis', 'cuantitativo', 'dashboard'],
          next: 'hr_06',
        ...
        },
        {
          ...
          cost: 2000000,
          revenue: 0,
          bsc: { bsc_financial: 0, bsc_customer: 3, bsc_internal: 3, bsc_learning: 5 },
          crossEffects: [
            { area: 'marketing', message: 'Clientes sienten que su opinion importa al evaluar servicio', bsc: { bsc_customer: 2 }, cost: 0 }
          ],
          tags: ['360-grados', 'feedback', 'integral'],
          next: 'hr_06',
        ...
        },
        {
          ...
          crossEffects: [
            { area: 'operations', message: 'Jefes de turno dedican 2 horas/mes a evaluar su equipo', bsc: { bsc_internal: 1 }, cost: 0 }
          ],
          tags: ['competencias', 'retroalimentacion', 'desarrollo'],
          next: 'hr_06',
        ...
        },
        {
          ...
          crossEffects: [
            { area: 'operations', message: 'Sin datos, las decisiones de personal son subjetivas', bsc: { bsc_internal: -3 }, cost: 0 }
          ],
          tags: ['sin-evaluacion', 'informal', 'riesgo'],
          next: 'hr_06',
    ...
    // ============================================================
    //  NODO 6 — DIA 15: Incentivos y compensacion (choice x4)
    // ============================================================
    'hr_06': {
      day: 15,
      ...
      options: [
        {
          ...
          cost: 6000000,
          revenue: 0,
          bsc: { bsc_financial: -1, bsc_customer: 2, bsc_internal: 4, bsc_learning: 2 },
          crossEffects: [
            { area: 'finance', message: 'Bonos suman ~$5M/mes al costo de nomina', bsc: { bsc_financial: -2 }, cost: -5000000 },
            { area: 'operations', message: 'Empleados motivados mejoran velocidad de servicio', bsc: { bsc_internal: 3 }, cost: 0 }
          ],
          tags: ['bonos', 'individual', 'desempeno'],
          next: 'hr_07',
        ...
        },
        {
          ...
          cost: 5000000,
          revenue: 0,
          bsc: { bsc_financial: 0, bsc_customer: 1, bsc_internal: 3, bsc_learning: 1 },
          crossEffects: [
            { area: 'operations', message: 'Menos tiempo perdido: empleados no salen a almorzar', bsc: { bsc_internal: 2 }, cost: 0 }
          ],
          tags: ['beneficios', 'alimentacion', 'transporte'],
          next: 'hr_07',
        ...
        },
        {
          ...
          crossEffects: [
            { area: 'operations', message: 'Empleados con vision a largo plazo cuidan mas los procesos', bsc: { bsc_internal: 2 }, cost: 0 }
          ],
          tags: ['plan-carrera', 'ascensos', 'desarrollo'],
          next: 'hr_07',
        ...
        },
        {
          ...
          crossEffects: [
            { area: 'marketing', message: 'Empleado del mes en redes sociales genera contenido autentico', bsc: { bsc_customer: 2 }, cost: 0 }
          ],
          tags: ['salario-emocional', 'flexibilidad', 'reconocimiento'],
          next: 'hr_07',
    ...
    // ============================================================
    //  NODO 7 — DIA 17: Crisis de retencion de talento (choice x4)
    // ============================================================
    'hr_07': {
      day: 17,
      ...
      options: [
        {
          ...
          cost: 5000000,
          revenue: 0,
          bsc: { bsc_financial: -2, bsc_customer: 2, bsc_internal: 3, bsc_learning: 0 },
          crossEffects: [
            { area: 'finance', message: 'Incremento salarial permanente de $800K/mes para 4 personas', bsc: { bsc_financial: -2 }, cost: -800000 },
            { area: 'operations', message: 'Empleados clave retenidos: continuidad operativa garantizada', bsc: { bsc_internal: 3 }, cost: 0 }
          ],
          tags: ['contraoferta', 'salarial', 'retencion'],
          next: 'hr_08',
        ...
        },
        {
          ...
          bsc: { bsc_financial: -1, bsc_customer: 2, bsc_internal: 3, bsc_learning: 3 },
          crossEffects: [
            { area: 'operations', message: 'Empleados clave con horario preferencial cubren los turnos criticos', bsc: { bsc_internal: 2 }, cost: 0 }
          ],
          tags: ['retencion', 'no-salarial', 'paquete'],
          next: 'hr_08',
        ...
        },
        {
          ...
          cost: 2000000,
          revenue: 0,
          bsc: { bsc_financial: 2, bsc_customer: -2, bsc_internal: -1, bsc_learning: 4 },
          crossEffects: [
            { area: 'operations', message: 'Curva de aprendizaje de los ascendidos baja productividad 2 semanas', bsc: { bsc_internal: -3 }, cost: 0 }
          ],
          tags: ['rotacion', 'promocion-interna', 'riesgo'],
          next: 'hr_08',
        ...
        },
        {
          ...
          cost: 8000000,
          revenue: 0,
          bsc: { bsc_financial: -3, bsc_customer: 3, bsc_internal: 4, bsc_learning: 2 },
          crossEffects: [
            { area: 'finance', message: 'Revision salarial general incrementa nomina $3M/mes', bsc: { bsc_financial: -3 }, cost: -3000000 },
            { area: 'operations', message: 'Equipo completo motivado: productividad sube 15%', bsc: { bsc_internal: 4 }, cost: 0 }
          ],
          tags: ['revision-general', 'equidad', 'alto-costo'],
          next: 'hr_08',
    ...
    // ============================================================
    //  NODO 8 — DIA 19: Programa de bienestar (multi, max 3)
    // ============================================================
    'hr_08': {
      day: 19,
      ...
      options: [
        {
          ...
          cost: 3000000,
          revenue: 0,
          bsc: { bsc_financial: 0, bsc_customer: 1, bsc_internal: 5, bsc_learning: 3 },
          crossEffects: [
            { area: 'operations', message: 'Protocolos de seguridad reducen incidentes en cocina', bsc: { bsc_internal: 4 }, cost: 0 }
          ],
          tags: ['sg-sst', 'arl', 'obligatorio', 'seguridad'],
          next: 'hr_09',
        ...
        },
        {
          ...
          cost: 2000000,
          revenue: 0,
          bsc: { bsc_financial: 0, bsc_customer: 2, bsc_internal: 3, bsc_learning: 2 },
          crossEffects: [
            { area: 'marketing', message: 'Fotos de integracion en redes muestran equipo unido', bsc: { bsc_customer: 1 }, cost: 0 }
          ],
          tags: ['integracion', 'comfamiliar', 'bienestar'],
          next: 'hr_09',
        ...
        },
        {
          ...
          bsc: { bsc_financial: -1, bsc_customer: 1, bsc_internal: 3, bsc_learning: 4 },
          crossEffects: [
            { area: 'operations', message: 'Empleados con mejor salud mental son mas productivos y empáticos', bsc: { bsc_internal: 2 }, cost: 0 }
          ],
          tags: ['salud-mental', 'psicologo', 'estres'],
          next: 'hr_09',
        ...
        },
        {
          ...
          crossEffects: [
            { area: 'marketing', message: 'Uniformes premium proyectan imagen profesional', bsc: { bsc_customer: 2 }, cost: 0 }
          ],
          tags: ['dotacion', 'espacios', 'comodidad'],
          next: 'hr_09',
        ...
        },
        {
          ...
          cost: 500000,
          revenue: 0,
          bsc: { bsc_financial: 3, bsc_customer: -1, bsc_internal: 0, bsc_learning: -2 },
          crossEffects: [],
          tags: ['minimo-legal', 'ahorro', 'basico'],
          next: 'hr_09',
    ...
    // ============================================================
    //  NODO 9 — DIA 22: Reestructuracion organizacional (choice x4)
    // ============================================================
    'hr_09': {
      day: 22,
      ...
      options: [
        {
          ...
          crossEffects: [
            { area: 'operations', message: 'Punto fuerte opera a maxima capacidad, el debil apenas cubre', bsc: { bsc_internal: 1 }, cost: 0 },
            { area: 'finance', message: 'Ingresos suben $3M/mes por capitalizar demanda del punto fuerte', bsc: { bsc_financial: 3 }, cost: 0 }
          ],
          tags: ['redistribucion', 'concentrar', 'demanda'],
          next: 'hr_10',
        ...
        },
        {
          ...
          cost: 3000000,
          revenue: 1500000,
          bsc: { bsc_financial: 1, bsc_customer: 3, bsc_internal: 3, bsc_learning: 3 },
          crossEffects: [
            { area: 'operations', message: 'Equipo flotante cubre picos sin sobrecarga fija', bsc: { bsc_internal: 3 }, cost: 0 },
            { area: 'finance', message: 'Costo adicional de $900K/mes en bonificacion de desplazamiento', bsc: { bsc_financial: -1 }, cost: -900000 }
          ],
          tags: ['flotante', 'polivalente', 'flexible'],
          next: 'hr_10',
        ...
        },
        {
          ...
          cost: 3500000,
          revenue: 2000000,
          bsc: { bsc_financial: 0, bsc_customer: 3, bsc_internal: 4, bsc_learning: 4 },
          crossEffects: [
            { area: 'operations', message: 'Decisiones locales agilizan respuesta a demanda cambiante', bsc: { bsc_internal: 3 }, cost: 0 }
          ],
          tags: ['descentralizar', 'jefes-sede', 'autonomia'],
          next: 'hr_10',
        ...
        },
        {
          ...
          bsc: { bsc_financial: -2, bsc_customer: 1, bsc_internal: 1, bsc_learning: 0 },
          crossEffects: [
            { area: 'finance', message: 'Nomina crece sin optimizar la estructura existente', bsc: { bsc_financial: -2 }, cost: -2000000 }
          ],
          tags: ['statu-quo', 'contratar-mas', 'ineficiente'],
          next: 'hr_10',
    ...
    // ============================================================
    //  NODO 10 — DIA 25: Decision final de clima laboral (binary)
    // ============================================================
    'hr_10': {
      day: 25,
      ...
      options: [
        {
          ...
          crossEffects: [
            { area: 'marketing', message: 'Evento genera contenido para redes y fortalece marca empleadora', bsc: { bsc_customer: 3 }, cost: 0 },
            { area: 'operations', message: 'Equipo motivado arranca el mes 2 con energia renovada', bsc: { bsc_internal: 3 }, cost: 0 }
          ],
          tags: ['evento', 'transparencia', 'clima', 'motivacion'],
          next: null,
        ...
        },
        {
          ...
          crossEffects: [
            { area: 'operations', message: 'Mejoras graduales sin disrupcion operativa', bsc: { bsc_internal: 1 }, cost: 0 }
          ],
          tags: ['mejora-silenciosa', 'bajo-perfil', 'conservador'],
          next: null,
