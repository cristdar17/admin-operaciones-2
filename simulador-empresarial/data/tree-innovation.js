      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "I+D comparte base de 500 encuestados para segmentacion",
              "bsc": {
                "bsc_customer": 2
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Focus groups revelan lenguaje emocional del consumidor",
              "bsc": {
                "bsc_customer": 3
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "I+D identifica tiempos de servicio y flujos de cocina de la competencia",
              "bsc": {
                "bsc_internal": 2
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "I+D entrega mapa de calor de demanda digital por zona",
              "bsc": {
                "bsc_customer": 2,
                "bsc_internal": 1
              },
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Operaciones debe buscar proveedores locales certificados",
              "bsc": {
                "bsc_internal": 2
              },
              "cost": 500000
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Operaciones necesita redisenar linea de ensamblaje para bowls",
              "bsc": {
                "bsc_internal": 3
              },
              "cost": 1000000
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "hr",
              "message": "RRHH debe capacitar cocineros en tecnicas asiaticas basicas",
              "bsc": {
                "bsc_learning": 3
              },
              "cost": 800000
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Marketing recibe linea fotografiable para campanas en Instagram",
              "bsc": {
                "bsc_customer": 3
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Operaciones cede espacio y equipos para el laboratorio temporal",
              "bsc": {
                "bsc_internal": -1
              },
              "cost": 300000
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "hr",
              "message": "RRHH identifica 2 aprendices SENA como posibles contrataciones",
              "bsc": {
                "bsc_learning": 3
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Finanzas recibe modelo de costeo por receta para proyecciones",
              "bsc": {
                "bsc_financial": 3
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Operaciones no se ve afectada por pruebas de I+D",
              "bsc": {
                "bsc_internal": 2
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Degustacion genera contenido organico en redes estudiantiles",
              "bsc": {
                "bsc_customer": 3
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Pop-up genera reconocimiento de marca en publico general",
              "bsc": {
                "bsc_customer": 2
              },
              "cost": 0
            ...
            {
              "area": "finance",
              "message": "Finanzas recibe datos de willingness-to-pay reales",
              "bsc": {
                "bsc_financial": 2
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Marketing obtiene 10 resenas de influencers para campana de lanzamiento",
              "bsc": {
                "bsc_customer": 5
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Operaciones prueba el flujo de preparacion a escala de delivery",
              "bsc": {
                "bsc_internal": 3
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Operaciones recibe equipo que reduce tiempos de coccion un 40%",
              "bsc": {
                "bsc_internal": 4
              },
              "cost": 0
            ...
            {
              "area": "hr",
              "message": "RRHH debe capacitar al equipo en uso del horno combi",
              "bsc": {
                "bsc_learning": 2
              },
              "cost": 500000
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Marketing obtiene canal directo de comunicacion con clientes via push",
              "bsc": {
                "bsc_customer": 4
              },
              "cost": 0
            ...
            {
              "area": "finance",
              "message": "Finanzas recibe datos de frecuencia y ticket promedio por cliente",
              "bsc": {
                "bsc_financial": 3
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Operaciones reduce errores de pedido con sistema digital",
              "bsc": {
                "bsc_internal": 3
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Rappi destaca el restaurante en su seccion de \"nuevos\" por 2 semanas",
              "bsc": {
                "bsc_customer": 3
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Operaciones recibe pedidos estructurados directamente del bot",
              "bsc": {
                "bsc_internal": 2
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Marketing debe crear campana de reposicionamiento urgente",
              "bsc": {
                "bsc_customer": 2
              },
              "cost": 1500000
            ...
            {
              "area": "operations",
              "message": "Operaciones ajusta recetas y presentacion en 48 horas",
              "bsc": {
                "bsc_internal": -1
              },
              "cost": 500000
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Operaciones se enfoca en reducir tiempo de servicio a 8 minutos",
              "bsc": {
                "bsc_internal": 3
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Operaciones debe cubrir turno de 5:30am para prep de desayunos",
              "bsc": {
                "bsc_internal": -1
              },
              "cost": 800000
            ...
            {
              "area": "hr",
              "message": "RRHH necesita contratar personal para turno de apertura",
              "bsc": {
                "bsc_learning": 1
              },
              "cost": 600000
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Marketing obtiene linea infantil para campanas en colegios",
              "bsc": {
                "bsc_customer": 3
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Operaciones necesita vitrina caliente y empaques biodegradables",
              "bsc": {
                "bsc_internal": 2
              },
              "cost": 400000
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Finanzas estructura contratos mensuales con empresas para flujo estable",
              "bsc": {
                "bsc_financial": 4
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Finanzas obtiene dashboard de rentabilidad por producto y franja horaria",
              "bsc": {
                "bsc_financial": 4
              },
              "cost": 0
            ...
            {
              "area": "operations",
              "message": "Operaciones visualiza cuellos de botella en tiempo real",
              "bsc": {
                "bsc_internal": 3
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Operaciones reduce desperdicio de alimentos un 25% con predicciones",
              "bsc": {
                "bsc_internal": 4,
                "bsc_financial": 2
              },
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Marketing usa promotores (NPS 9-10) para programa de referidos",
              "bsc": {
                "bsc_customer": 4
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Marketing crea combos basados en datos reales de compra conjunta",
              "bsc": {
                "bsc_customer": 2,
                "bsc_financial": 2
              },
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Finanzas proyecta punto de equilibrio del segundo local en 4 meses",
              "bsc": {
                "bsc_financial": 3
              },
              "cost": 0
            ...
            {
              "area": "hr",
              "message": "RRHH inicia busqueda de administrador para sucursal Dosquebradas",
              "bsc": {
                "bsc_learning": 2
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Operaciones documenta todos los procesos para replicabilidad",
              "bsc": {
                "bsc_internal": 5
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Marketing posiciona la marca en el canal retail con empaques premium",
              "bsc": {
                "bsc_customer": 3
              },
              "cost": 800000
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "hr",
              "message": "RRHH estructura rol de \"Chef de Innovacion\" dentro del equipo",
              "bsc": {
                "bsc_learning": 4
              },
              "cost": 0
