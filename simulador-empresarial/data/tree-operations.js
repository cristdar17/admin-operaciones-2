/**
 * Árbol de decisiones v2 — Operaciones
 * 25 días, 10 nodos, temas de Administración de Operaciones II
 * Presupuesto: $130M COP | Contexto: Pereira, Colombia
 */
window.TREE_OPERATIONS = {
  ...
  nodes: {
    ...
    // ── 1. Capacidad de producción (Punto de equilibrio) ──────────
    'ops_01': {
      day: 1,
      ...
      options: [
        {
          ...
          crossEffects: [{ area: 'hr', message: 'Se necesitan 8 contrataciones nocturnas urgentes', bsc: { bsc_learning: -2 } }],
          tags: ['turno_extra'],
          next: 'ops_02',
        ...
        },
        {
          ...
          crossEffects: [{ area: 'finance', message: 'Costo variable sube pero sin inversión fija', bsc: { bsc_financial: 2 } }],
          tags: ['subcontratacion'],
          next: 'ops_02',
        ...
        },
        {
          ...
          crossEffects: [{ area: 'hr', message: 'Empleados capacitados en métodos eficientes', bsc: { bsc_learning: 3 } }],
          tags: ['optimizacion'],
          next: 'ops_02',
    ...
    // ── 2. Control de calidad (SPC, Poka-Yoke) ──────────────────
    'ops_02': {
      day: 3,
      ...
      options: [
        {
          ...
          cost: 8000000,
          revenue: 4000000,
          bsc: { bsc_financial: -1, bsc_customer: 4, bsc_internal: 5, bsc_learning: 3 },
          crossEffects: [{ area: 'marketing', message: 'Calificación online mejora gradualmente', bsc: { bsc_customer: 2 } }],
          tags: ['spc'],
          next: 'ops_03',
        ...
        },
        {
          ...
          cost: 10000000,
          revenue: 3000000,
          bsc: { bsc_financial: -2, bsc_customer: 5, bsc_internal: 4, bsc_learning: 2 },
          crossEffects: [{ area: 'finance', message: 'Reducción de desperdicio por errores', bsc: { bsc_financial: 2 } }],
          tags: ['poka_yoke'],
          next: 'ops_03',
        ...
        },
        {
          ...
          cost: 5000000,
          revenue: 1000000,
          bsc: { bsc_financial: 0, bsc_customer: 2, bsc_internal: 1, bsc_learning: 0 },
          crossEffects: [{ area: 'hr', message: 'Supervisores sobrecargados y desmotivados', bsc: { bsc_learning: -1 } }],
          tags: ['inspeccion'],
          next: 'ops_03',
    ...
    // ── 3. Modelo de inventarios (EOQ vs JIT) ───────────────────
    'ops_03': {
      day: 5,
      ...
      options: [
        {
          ...
          crossEffects: [{ area: 'finance', message: 'Capital inmovilizado en inventario', bsc: { bsc_financial: -1 } }],
          tags: ['eoq'],
          next: 'ops_04',
        ...
        },
        {
          ...
          crossEffects: [{ area: 'marketing', message: 'Ingredientes frescos como diferenciador de marca', bsc: { bsc_customer: 3 } }],
          tags: ['jit'],
          next: 'ops_04',
      ...
      options: [
        {
          ...
          cost: 3000000,
          revenue: 2000000,
          bsc: { bsc_financial: 1, bsc_customer: 2, bsc_internal: 3, bsc_learning: 2 },
          crossEffects: [],
          tags: ['promedio_movil'],
          next: 'ops_05',
        ...
        },
        {
          ...
          revenue: 3000000,
          bsc: { bsc_financial: 1, bsc_customer: 3, bsc_internal: 4, bsc_learning: 3 },
          crossEffects: [{ area: 'finance', message: 'Mejor planificación reduce sobreproducción', bsc: { bsc_financial: 2 } }],
          tags: ['suavizacion'],
          next: 'ops_05',
        ...
        },
        {
          ...
          cost: 8000000,
          revenue: 5000000,
          bsc: { bsc_financial: 0, bsc_customer: 4, bsc_internal: 5, bsc_learning: 5 },
          crossEffects: [{ area: 'hr', message: 'Se necesita analista de datos dedicado', bsc: { bsc_learning: 2 } }],
          tags: ['regresion'],
          next: 'ops_05',
    ...
    // ── 5. Cuello de botella / Teoría de Restricciones ───────────
    'ops_05': {
      day: 10,
      ...
      options: [
        {
          ...
          cost: 22000000,
          revenue: 10000000,
          bsc: { bsc_financial: -3, bsc_customer: 3, bsc_internal: 5, bsc_learning: 1 },
          crossEffects: [{ area: 'finance', message: 'Inversión fuerte en activo fijo', bsc: { bsc_financial: -2 } }],
          tags: ['elevar_restriccion'],
          next: 'ops_06',
        ...
        },
        {
          ...
          cost: 5000000,
          revenue: 4000000,
          bsc: { bsc_financial: 2, bsc_customer: 2, bsc_internal: 4, bsc_learning: 4 },
          crossEffects: [{ area: 'hr', message: 'Equipo aprende a trabajar al ritmo del cuello de botella', bsc: { bsc_learning: 3 } }],
          tags: ['explotar_subordinar'],
          next: 'ops_06',
    ...
    // ── 6. Lean Manufacturing (5S, VSM, Kaizen) ─────────────────
    'ops_06': {
      day: 13,
      ...
      options: [
        {
          ...
          crossEffects: [{ area: 'hr', message: 'Cultura de orden mejora clima laboral', bsc: { bsc_learning: 2 } }],
          tags: ['5s'],
          next: 'ops_07',
        ...
        },
        {
          ...
          crossEffects: [{ area: 'hr', message: 'Empleados empoderados proponen ideas propias', bsc: { bsc_learning: 3 } }],
          tags: ['kaizen'],
          next: 'ops_07',
        ...
        },
        {
          ...
          crossEffects: [{ area: 'finance', message: 'Inversión alta con ROI a mediano plazo', bsc: { bsc_financial: -1 } }],
          tags: ['automatizacion'],
          next: 'ops_07',
    ...
    // ── 7. Mantenimiento (TPM vs Reactivo) ──────────────────────
    'ops_07': {
      day: 15,
      ...
      options: [
        {
          ...
          cost: 10000000,
          revenue: 6000000,
          bsc: { bsc_financial: 0, bsc_customer: 3, bsc_internal: 5, bsc_learning: 5 },
          crossEffects: [{ area: 'hr', message: 'Operarios con nuevas habilidades técnicas', bsc: { bsc_learning: 3 } }],
          tags: ['tpm'],
          next: 'ops_08',
        ...
        },
        {
          ...
          cost: 7000000,
          revenue: 3000000,
          bsc: { bsc_financial: 0, bsc_customer: 2, bsc_internal: 3, bsc_learning: 1 },
          crossEffects: [],
          tags: ['preventivo_externo'],
          next: 'ops_08',
        ...
        },
        {
          ...
          crossEffects: [{ area: 'marketing', message: 'Paradas generan demoras visibles al cliente', bsc: { bsc_customer: -2 } }],
          tags: ['reactivo'],
          next: 'ops_08',
      ...
      options: [
        {
          ...
          cost: 3000000,
          revenue: 2000000,
          bsc: { bsc_financial: 2, bsc_customer: 1, bsc_internal: 5, bsc_learning: 3 },
          crossEffects: [],
          tags: ['redistribuir'],
          next: 'ops_09',
        ...
        },
        {
          ...
          crossEffects: [{ area: 'hr', message: 'Contratación adicional para la línea', bsc: { bsc_learning: -1 } }],
          tags: ['operario_extra'],
          next: 'ops_09',
        ...
        },
        {
          ...
          cost: 15000000,
          revenue: 5000000,
          bsc: { bsc_financial: -2, bsc_customer: 3, bsc_internal: 4, bsc_learning: 2 },
          crossEffects: [{ area: 'finance', message: 'Inversión en equipamiento adicional', bsc: { bsc_financial: -1 } }],
          tags: ['estacion_paralela'],
          next: 'ops_09',
    ...
    // ── 9. Planeación agregada (Chase vs Level) ─────────────────
    'ops_09': {
      day: 21,
      ...
      options: [
        {
          ...
          crossEffects: [{ area: 'hr', message: 'Alta rotación genera costos y mal clima laboral', bsc: { bsc_learning: -3 } }],
          tags: ['chase'],
          next: 'ops_10',
        ...
        },
        {
          ...
          cost: 10000000,
          revenue: 5000000,
          bsc: { bsc_financial: 0, bsc_customer: 2, bsc_internal: 4, bsc_learning: 3 },
          crossEffects: [{ area: 'finance', message: 'Capital atado en inventario durante meses bajos', bsc: { bsc_financial: -1 } }],
          tags: ['level'],
          next: 'ops_10',
        ...
        },
        {
          ...
          cost: 11000000,
          revenue: 6000000,
          bsc: { bsc_financial: 1, bsc_customer: 3, bsc_internal: 3, bsc_learning: 2 },
          crossEffects: [{ area: 'hr', message: 'Equipo base estable con temporales en picos', bsc: { bsc_learning: 1 } }],
          tags: ['mixta'],
          next: 'ops_10',
    ...
    // ── 10. Estrategia final de operaciones ─────────────────────
    'ops_10': {
      day: 24,
      ...
      options: [
        {
          ...
          cost: 8000000,
          revenue: 6000000,
          bsc: { bsc_financial: 5, bsc_customer: 1, bsc_internal: 5, bsc_learning: 2 },
          crossEffects: [{ area: 'marketing', message: 'Posicionamiento como opción económica y confiable', bsc: { bsc_customer: 2 } }],
          tags: ['costo'],
          next: null,
        ...
        },
        {
          ...
          cost: 15000000,
          revenue: 10000000,
          bsc: { bsc_financial: 2, bsc_customer: 5, bsc_internal: 3, bsc_learning: 3 },
          crossEffects: [{ area: 'marketing', message: 'Marca premium reconocida en el Eje Cafetero', bsc: { bsc_customer: 3 } }],
          tags: ['calidad'],
          next: null,
        ...
        },
        {
          ...
          cost: 11000000,
          revenue: 7000000,
          bsc: { bsc_financial: 2, bsc_customer: 4, bsc_internal: 4, bsc_learning: 5 },
          crossEffects: [{ area: 'hr', message: 'Equipo polivalente y creativo', bsc: { bsc_learning: 3 } }],
          tags: ['flexibilidad'],
          next: null,
        ...
        },
        {
          ...
          crossEffects: [{ area: 'marketing', message: 'Reconocimiento como restaurante sostenible', bsc: { bsc_customer: 4 } }],
          tags: ['sostenibilidad'],
          next: null,
