      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Descuento del 12% por volumen — ahorro mensual estimado $3.2M",
              "bsc": {
                "bsc_financial": 3
              },
              "cost": 0
            ...
            {
              "area": "operations",
              "message": "Un proveedor simplifica recepcion pero limita variedad de calidades",
              "bsc": {
                "bsc_internal": 1
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "6 proveedores con plazos distintos — tesoreria debe coordinar flujos",
              "bsc": {
                "bsc_financial": -2
              },
              "cost": 0
            ...
            {
              "area": "operations",
              "message": "Multiples proveedores permiten seleccionar mejor calidad por ingrediente",
              "bsc": {
                "bsc_internal": 2,
                "bsc_customer": 1
              },
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Modelo hibrido optimiza costos en basicos y calidad en frescos",
              "bsc": {
                "bsc_financial": 1
              },
              "cost": 0
            ...
            {
              "area": "operations",
              "message": "Balance entre simplicidad operativa y calidad premium en frescos",
              "bsc": {
                "bsc_internal": 2
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Arriendo bodega $4.5M/mes — costo fijo significativo pero predecible",
              "bsc": {
                "bsc_financial": -2
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Cada sede controla su inventario — rapido pero sin estandarizacion",
              "bsc": {
                "bsc_internal": -1
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Cross-docking elimina inventario pero cualquier retraso de proveedor impacta directo",
              "bsc": {
                "bsc_internal": -2
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "EOQ optimiza costos de inventario — reduccion estimada del 18% en desperdicios",
              "bsc": {
                "bsc_financial": 3
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Clasificacion ABC prioriza control en ingredientes criticos — menos agotados",
              "bsc": {
                "bsc_internal": 2
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Inversion fuerte en tecnologia ($10M) pero visibilidad total del inventario",
              "bsc": {
                "bsc_financial": -1
              },
              "cost": 0
            ...
            {
              "area": "operations",
              "message": "Datos en tiempo real permiten ajustar produccion al instante",
              "bsc": {
                "bsc_internal": 3
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Compra de 2 furgones: $18M de inversion + $2.5M/mes en operacion",
              "bsc": {
                "bsc_financial": -3
              },
              "cost": 0
            ...
            {
              "area": "marketing",
              "message": "Furgones con branding de la marca recorriendo Pereira — publicidad movil gratis",
              "bsc": {
                "bsc_customer": 2
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Rappi cobra 25% de comision — costo variable pero sin inversion inicial",
              "bsc": {
                "bsc_financial": 2
              },
              "cost": 0
            ...
            {
              "area": "marketing",
              "message": "Presencia en Rappi expone la marca a 50.000+ usuarios en Pereira",
              "bsc": {
                "bsc_customer": 3
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Rutas fijas son predecibles — las sedes saben exactamente cuando llega el producto",
              "bsc": {
                "bsc_internal": 1
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Rutas optimizadas reducen tiempo de entrega 20% — mas frescura",
              "bsc": {
                "bsc_internal": 2,
                "bsc_customer": 1
              },
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Entregas interdiarias reducen costo de combustible 45%",
              "bsc": {
                "bsc_financial": 2
              },
              "cost": 0
            ...
            {
              "area": "operations",
              "message": "Menos entregas pero sedes deben almacenar mas — riesgo de vencimiento en frescos",
              "bsc": {
                "bsc_internal": -1
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Sobrecosto del 30% en carne por compra de emergencia — $1.8M adicionales",
              "bsc": {
                "bsc_financial": -2
              },
              "cost": 1800000
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Clientes preguntan por los platos de carne — 12 quejas en redes sociales",
              "bsc": {
                "bsc_customer": -2
              },
              "cost": 0
            ...
            {
              "area": "operations",
              "message": "Cocina se adapta rapido a menu reducido — muestra flexibilidad operativa",
              "bsc": {
                "bsc_internal": 1
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Cuartos frios con sensores eliminan desperdicios por ruptura de frio — ahorro $1.5M/mes",
              "bsc": {
                "bsc_internal": 3
              },
              "cost": 0
            ...
            {
              "area": "finance",
              "message": "Inversion de $14M en cadena de frio — retorno en 8 meses por reduccion de mermas",
              "bsc": {
                "bsc_financial": -1
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Protocolo manual de cadena de frio — depende de disciplina del personal",
              "bsc": {
                "bsc_internal": 0
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Cero almacenamiento de frio — todo debe llegar y usarse el mismo dia",
              "bsc": {
                "bsc_internal": -2
              },
              "cost": 0
            ...
            {
              "area": "marketing",
              "message": "Slogan \"De la finca a tu plato hoy\" — diferenciador potente",
              "bsc": {
                "bsc_customer": 3
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Compras consolidadas generan descuento del 15% — ahorro de $2.8M/mes",
              "bsc": {
                "bsc_financial": 3
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Cocina central estandariza sabor — los clientes reciben lo mismo en cualquier sede",
              "bsc": {
                "bsc_internal": 3,
                "bsc_customer": 2
              },
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Alianza de compras con restaurante amigo — descuento adicional 8% en basicos",
              "bsc": {
                "bsc_financial": 2
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Empaques con marca propia — cada domicilio es publicidad en manos del cliente",
              "bsc": {
                "bsc_customer": 3
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Compras de emergencia a precio retail — sobrecosto del 40%",
              "bsc": {
                "bsc_financial": -2
              },
              "cost": 2000000
            ...
            {
              "area": "operations",
              "message": "Operacion continua a pesar del paro — clientes ni se enteran",
              "bsc": {
                "bsc_internal": 2,
                "bsc_customer": 1
              },
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "2 sedes cerradas 3 dias — clientes de Cuba y Circunvalar se van a la competencia",
              "bsc": {
                "bsc_customer": -3
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "marketing",
              "message": "Comunicado en redes: \"Menu especial por paro\" — transparencia valorada por clientes",
              "bsc": {
                "bsc_customer": 1
              },
              "cost": 0
            ...
            {
              "area": "operations",
              "message": "Cocina simplificada a 5 platos — operacion mas rapida y eficiente",
              "bsc": {
                "bsc_internal": 2
              },
              "cost": 0
      ...
      "options": [
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Cadena agil permite adaptarse rapido a cambios de demanda y crisis",
              "bsc": {
                "bsc_internal": 3
              },
              "cost": 0
            ...
            {
              "area": "marketing",
              "message": "Capacidad de respuesta rapida como ventaja competitiva",
              "bsc": {
                "bsc_customer": 2
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Modelo lean reduce costos operativos 22% — margen de ganancia sube",
              "bsc": {
                "bsc_financial": 4
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "operations",
              "message": "Cadena resiliente garantiza operacion continua ante cualquier disrupcion",
              "bsc": {
                "bsc_internal": 4
              },
              "cost": 0
        ...
        },
        {
          ...
          "crossEffects": [
            {
              "area": "finance",
              "message": "Inversion alta en tecnologia ($12M) pero prediccion de demanda reduce mermas 35%",
              "bsc": {
                "bsc_financial": 2
              },
              "cost": 0
            ...
            {
              "area": "marketing",
              "message": "Imagen de cadena innovadora y tecnologica — atrae talento joven",
              "bsc": {
                "bsc_customer": 1
              },
              "cost": 0
